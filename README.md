...
* [`latest`, `alpine` Dockerfile](https://github.com/mkenney/docker-npm/blob/master/Dockerfile) ![Image size](https://img.shields.io/badge/image size-62MB-blue.svg)
...
* [`debian` Dockerfile](https://github.com/mkenney/docker-npm/blob/master/Dockerfile) ![Image size](https://img.shields.io/badge/image size-~300MB-blue.svg)
...
* [`7.0-alpine` Dockerfile](https://github.com/mkenney/docker-npm/blob/7.0-alpine/Dockerfile) ![Image size](https://img.shields.io/badge/image size-62MB-blue.svg)

  Based on [`alpine:3.4`](https://hub.docker.com/r/library/alpine/tags/3.4/) with `node` v7.0 compiled from source.

* [`7.0-debian` Dockerfile](https://github.com/mkenney/docker-npm/blob/7.0-debian/Dockerfile) ![Image size](https://img.shields.io/badge/image size-301MB-blue.svg)

  Based on[`node:7.0-wheezy`](https://hub.docker.com/r/library/node/tags/6.9-wheezy/).
